          ...
          <ul> 
            ...
            <li><xsl:value-of select="count(analysis/table/column)+count(analysis/table/pkey)"/> champs dont :
               <ul>
                 ...
                 <li><xsl:value-of select="count(analysis/table/pkey)+count(analysis/table/column[@pkey='true'])"/> clés primaires</li>
               </ul>
            </li>
          </ul>
...
Le taux de liaison est de <xsl:value-of select="100 * (count(analysis/table/column[@fkey!='']) div count(analysis/table/column[not(@pkey='true')]))"/>%.<br/>
        ...
        <div class="texte">
          <ul>
            ...
            <li> 
              ...
              <xsl:apply-templates select="analysis/table[@label='']" mode="text-name"/>
              <xsl:text> ...</xsl:text>
              <!--
              <ul>
  ...
  <xsl:template match="table" mode="text-name">
